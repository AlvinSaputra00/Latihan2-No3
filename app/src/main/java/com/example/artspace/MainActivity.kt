...
private fun ArtSpace() {
    ...
    when (artworkIndex) {
        0 -> {
            artwork = R.drawable.barcelona
            artworkDescription = R.string.Barcelona_description
            artworkName = R.string.Barcelona_title
            artworkReleaseYear = R.string.twentytwentyone
        }
        1 -> {
            artwork = R.drawable.real_madrid
            artworkDescription = R.string.Real_Madrid_description
            artworkName = R.string.Real_Madrid_title
            artworkReleaseYear = R.string.twentytwentyone
        }
        2 -> {
            artwork = R.drawable.mci
            artworkDescription = R.string.Mci_description
            artworkName = R.string.Mci_title
            artworkReleaseYear = R.string.twentytwentytwo
        }
        else -> {
            artwork = R.drawable.mu
            artworkDescription = R.string.Mu_description
            artworkName = R.string.Mu_title
